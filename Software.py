...
var = tkinter.StringVar()
var.set('A')
l = tkinter.Label(win, text='Choose one AutoML framework to be tested:',font=ft1)
#l.pack()
...
r1 = tkinter.Radiobutton(win,text='A. CF-DAML  ',
                         variable=var, value='CF-DAML',font=ft1,
                         command=choose_model, compound=tkinter.CENTER)
r1.pack()
r2 = tkinter.Radiobutton(win, text='B. Dsa-PAML',
                         variable=var, value='Dsa-PAML',font=ft1,
                         command=choose_model, compound=tkinter.CENTER)
r2.pack()
